                ...
                >
                  <Dialog.Panel className="pointer-events-auto relative w-screen md:w-auto">
                    <div className="absolute top-0 right-0 -ml- flex pt-4 pr-2 ">
                      <button
                        type="button"
                        className="rounded-md text-base hover:text-base-hover focus:outline-none focus:ring-2 focus:ring-white"
                    ...
                    <div className="flex h-full flex-col overflow-hidden bg-secondary-bg">
                      <div className="px-4 sm:px-6">
                        <Dialog.Title className="text-lg font-medium text-base">{navHeader}</Dialog.Title>
                      </div>
                      <div className="relative mt-6 flex-1 space-y-4 px-4 sm:px-6">
                        {navItems.map((item) => {
                          return (
                            <div key={item.heading}>
                              <a href={item.href} className="text-base md:pr-20 block rounded-lg px-3 hover:bg-primary hover:text-base-light">
